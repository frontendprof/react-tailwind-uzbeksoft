...
const GamePass = () => {
    return (
        <section className="hero gamepass-hero xl:mx-20">
            <div>
                <img src={GamePassImg} alt="game_pass_img" className="hero-img"/>
            </div>
            ...
            <div className="overlay bg-gray-800 text-center px-10 py-20 text-white sm:bg-transparent sm:text-left">
                ...
                <p className="mb-4 text">Get your first 3 months of Xbox Game Pass Ultimate membership for $1. Now includes EA Play. New subscribers only.</p>
